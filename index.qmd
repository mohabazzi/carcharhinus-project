...
R.packages <- c("geomorph openxlsx dplyr ggplot2 phytools geiger phangorn tibble geometry
                 ...
                 boot broom rredlist treemap ggrepel dispRity fields abind forcats ggtern")
...
plot(average_upper_jaw$x[,1:2],
     ...
     xlim = c(-0.1865064,0.1530878),ylim = c(-0.05455346,0.08755696),
     xlab = "PC 1: 77.35%", ylab = "PC 2: 10.27%", 
     font.lab = 2,cex.axis = .7,cex.lab = .7,);minor.tick(nx = 2, ny = 2, tick.ratio = 0.5)
...
polygon(average_upper_jaw$x[!rownames(average_pca$x) %in% crEnVunT,1:2][hull.9,],
        lty = 2,border = "#4CAF50",lwd = 2) # CR,EN, VU, and NT eliminated

points(average_upper_jaw$x[!rownames(average_pca$x) %in% crEnVunT,1:2], col = "orange",pch = 19, cex = 3)
